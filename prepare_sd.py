...
##############################################################
#
# Ask questions to prepare cloud-init file for mini pupper with Stanford controller and web GUI
#
# if ~/.web_gui.txt exists no questions will be asked
#
##############################################################
...
conf_file = os.path.join(os.path.expanduser("~"), '.web_gui.txt')
...
- git
runcmd:
- [ su, ubuntu, -c, "git clone https://github.com/mangdangroboticsclub/mini_pupper_web_controller.git /home/ubuntu/mini_pupper_web_controller" ]
- [ su, ubuntu, -c, "/home/ubuntu/mini_pupper_web_controller/%s %s 2> /home/ubuntu/.setup_err.log > /home/ubuntu/.setup_out.log" ]
- [ reboot ]
"""
